...
class BiasedBoundaryAttack:
    ...
    def run_attack(self, X_orig, label, is_targeted, X_start, n_calls_left_fn, n_max_per_batch=50, n_seconds=None,
        ...
        :param recalc_mask_every: If not none, automatically calculates a mask from the current image difference. Will recalculate this mask every (n) steps.
        ...
        try:
            ...
            while n_calls_left_fn() > 3:
                ...
                # Recalculate mask from current diff (hopefully this reduces the search space)
    ...
    def generate_boundary_sample(self, X_orig, X_adv_current, mask, source_step, spherical_step, sampling_fn, pgs_current=None, pg_factor=0.5):
